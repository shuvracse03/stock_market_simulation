...
def test_get_user1(test_db):
    ...
    response = client.post(api_post, json=data)
    response = client.get(api_get)
    assert response.status_code == 200
...
def test_post_stock2(test_db):
    ...
    response = client.post(api_post, json=data).json()
...
def test_get_stock1(test_db):
    ...
    api_post = "/stocks/"
    api_get = "/stocks/"
    response = client.post(api_post, json=data1)
    response = client.post(api_post, json=data2)
    response = client.get(api_get)
